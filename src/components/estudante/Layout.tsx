...
const NAV_ITEMS: { to: string; label: string; icon: React.ReactNode }[] = [
  { to: "/estudante/papeis-submetidos", label: "Resumos Submetidos", icon: <><path d="M15 2H9a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2V7z"/><polyline points="15 2 15 7 20 7"/><path d="M4 8v12a2 2 0 0 0 2 2h9"/></> },
  ...
  { to: "/estudante/cronograma", label: "Cronograma", icon: <><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></> },
      ...
      <aside className="sidebar">
        ...
        <NavLink to="/estudante/papeis-submetidos" className="sidebar-logo">
          ...
          <div>
            ...
            <div className="logo-sub">Submissão</div>
          </div>
        </NavLink>
