...
const NAV_ITEMS: { to: string; label: string; icon: React.ReactNode }[] = [
  { to: "/estudante/papeis-submetidos", label: "Papéis Submetidos", icon: <><path d="M15 2H9a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2V7z"/><polyline points="15 2 15 7 20 7"/><path d="M4 8v12a2 2 0 0 0 2 2h9"/></> },
