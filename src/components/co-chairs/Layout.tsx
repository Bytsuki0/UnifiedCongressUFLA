      ...
      <aside className="sidebar" style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
        ...
        <NavLink to="/co-chairs/dashboard" className="sidebar-logo">
          ...
          <div>
            ...
            <div className="logo-sub">Gerenciamento</div>
          </div>
        </NavLink>
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          ...
          <nav className="sidebar-nav">
            <NavLink to="/co-chairs/dashboard" title="Painel de Controle" className={({ isActive }) => navItem(isActive)}>
            ...
            <NavLink to="/co-chairs/avaliadores" title="Co-chairs" className={({ isActive }) => navItem(isActive)}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}>
            ...
            <NavLink to="/co-chairs/categorias" title="Categorias" className={({ isActive }) => navItem(isActive)}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}>
            ...
            <NavLink to="/co-chairs/cronograma" title="Cronograma" className={({ isActive }) => navItem(isActive)}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}>
            ...
            <NavLink to="/co-chairs/downloads" title="Links de Downloads" className={({ isActive }) => navItem(isActive)}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}>
        ...
        <div>
          ...
          <div className="sidebar-footer">
            <button className="nav-item" onClick={handleLogout} title="Sair" style={{ width: "100%", background: "none", border: "none", cursor: "pointer" }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}>
