        ...
        {pareceres.length > 0 && (
          <div className="step-card">
            <div className="step-card-header">
              ...
              <div>
                <div className="step-title">Pareceres dos avaliadores</div>
            ...
            {pareceres.map((p) => (
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <span className="badge badge-gray">{RESULTADO_LABEL[p.resultado] ?? p.resultado}</span>
                </div>
                {p.comentario_geral && (
                  <div style={{ fontSize: "var(--fs-sm)", background: "var(--gray-50)", padding: 8, borderRadius: 4, marginBottom: 8, lineHeight: "var(--lh-normal)" }}>
                    {p.comentario_geral}
                  </div>
                )}
                {p.itens.length > 0 && (
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 6 }}>
                    {p.itens.map((it) => (
                      <li key={it.criterio_id} style={{ fontSize: "var(--fs-xs)", color: "var(--color-text-secondary)" }}>
                        <strong>{it.titulo}:</strong> nota {it.nota}
