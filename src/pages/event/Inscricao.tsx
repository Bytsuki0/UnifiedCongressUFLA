      ...
      <div className="flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link to={e("/minicursos")} className="text-sm font-medium text-primary hover:underline">
              Explorar minicursos →
            </Link>
          </div>
          ...
          {!myMinis.isLoading && minis.length === 0 && (
            <div className="rounded-2xl border border-dashed border-border p-6 text-center">
              ...
              <Link to={e("/minicursos")} className="mt-3 inline-block rounded-xl px-4 py-2 text-sm font-semibold text-white"
                style={{ backgroundImage: "var(--gradient-primary)" }}>
