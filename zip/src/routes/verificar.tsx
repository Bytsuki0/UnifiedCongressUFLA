...
export const Route = createFileRoute("/verificar")({
  head: () => ({
    meta: [
      { title: "Verificar Certificado — Congresso UFLA Paraíso" },
      { name: "description", content: "Verifique a autenticidade de um certificado emitido pelo Congresso Unificado UFLA Paraíso." },
    ],
  }),
  component: VerificarPublico,
});

function VerificarPublico() {
