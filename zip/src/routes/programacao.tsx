...
export const Route = createFileRoute("/programacao")({
  head: () => ({ meta: [{ title: "Programação — Congresso UFLA Paraíso" }] }),
    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative mx-auto max-w-5xl p-6 md:p-10">
        <div className="mb-6 flex items-center justify-between">
          <Link to="/"><Logo /></Link>
          <Link to="/auth" className="rounded-xl px-4 py-2 text-sm font-semibold text-white" style={{ backgroundImage: "var(--gradient-primary)" }}>
            Entrar
          </Link>
        </div>
